    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DOD_Wiped', models.CharField(choices=[('None', 'No'), ('Yes Wiped', 'Yes'), ('Not Wiped', 'No')], default='None', max_length=20)),
                ('Disposed', models.CharField(choices=[('None', 'No'), ('Yes Disposed', 'Yes'), ('Not Disposed', 'No')], default='None', max_length=20)),
                ('Reused', models.CharField(choices=[('Pick One', 'Pick'), ('Yes Reused', 'Yes'), ('Not Reused', 'No')], default='Pick One', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Item',
            fields=[
                ...
                ('Sold_To', models.CharField(blank=True, max_length=120, null=True)),
                ('Paid', models.CharField(choices=[('None', 'No'), ('Yes Paid', 'Yes'), ('Not Paid', 'No')], default='None', max_length=120)),
